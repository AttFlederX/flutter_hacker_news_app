...
abstract class $CommentCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String by, int time, String text, List<int>? kids});
}
...
class _$CommentImpl extends _Comment with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Comment(id: $id, by: $by, time: $time, text: $text, kids: $kids)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, by, time, text,
...
abstract class _Comment extends Comment {
  const factory _Comment(
      ...
      required final List<int>? kids}) = _$CommentImpl;
